                ...
                <div class="col-lg-12">
                    <div class="tabs-container">
                        <ul class="nav nav-tabs">
                            <li><a class="nav-link active" data-toggle="tab"> Article info</a></li>
                        </ul>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row">
                                                <label for="meta_tag_title" class="col-sm-2 col-form-label">Meta Tag
                                                    Title:</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="meta_tag_title" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="meta_tag_description" class="col-sm-2 col-form-label">Meta Tag
                                                    Description:</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="meta_tag_description" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
