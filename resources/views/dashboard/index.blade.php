...
//dynamic content
                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="" class="rounded-circle message-avatar" src="images/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="" class="rounded-circle message-avatar" src="images/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="" class="rounded-circle message-avatar"
                                            src="images/a3.jpg">
    ...
    <div class="toast toast toast-bootstrap hide" role="alert" aria-live="assertive" aria-atomic="true"
